...
#define NUM_ELEMENTS		32768				// same as array size
#define	NUM_WORK_GROUPS		NUM_ELEMENTS/LOCAL_SIZE

const char *			CL_FILE_NAME = { "opencl7b.cl" };
const float			TOL = 0.0001f;

float *hA =     new float[ 2*NUM_ELEMENTS ];
...
int main( int argc, char *argv[ ] )
{
	...
	status = clEnqueueWriteBuffer( cmdQueue, dA, CL_FALSE, 0, 2*Size, hA, 0, NULL, NULL );
	if( status != CL_SUCCESS )
	...
	// Print performance
	fprintf( stderr, "%8d\t%4d\t%10d\t%10.3lf MegaMultAddsPerSecond\n",
